...
const REQUIRED = [
  ...
  ["unit-conversions.ts", "export async function createUnitConversionsBatch", "await getLiveSession()"],
  ["unit-conversions.ts", "export async function updateUnitConversion", "await getLiveSession()"],
  ["unit-conversions.ts", "export async function deleteUnitConversion", "await getLiveSession()"],
